...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Perintah Ini Hanya Dapat Digunakan _*PEMILIK*_',
        owner: 'Perintah Ini Hanya Dapat Digunakan _*Owner Bot*_!',
        mods: 'Perintah Ini Hanya Dapat Digunakan _*Moderator*_ !',
        premium: 'Perintah Ini Hanya Untuk Pengguna _*Premium*_ !',
        group: 'Perintah Ini Hanya Berlaku Untuk Grup!',
        private: 'Perintah Ini Hanya Berlaku Di Chat Pribadi!',
        admin: 'Perintah Ini Hanya Untuk _*Admin*_ Grup!',
        botAdmin: 'Jadikan Bot Sebagai _*Admin*_ Untuk Menggunakan Perintah!',
        unreg: 'SILAHKAN DAFTAR UNTUK MENGGUNAKAN FITUR INI DENGAN KETIK:\n\n*#daftar nama.umur*\n\nCONTOH: *#daftar Manusia.16*',
        restrict: 'Fitur Ini Di _*MATIKAN !*_'
    }[type]
